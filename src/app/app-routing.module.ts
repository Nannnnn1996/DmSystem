...
import{AddDictionaryComponent} from './function/dictionary/add-dictionary/add-dictionary.component'
const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent},
  {
    ...
    children: [
        ...
        { path: 'direction/add_dictionary', component: AddDictionaryComponent }
    ],
